...
// Label: V4.0 (Live Backend Integration) — Connects to the Node.js server for live Facebook OAuth login.
// Notes:
// - Removes the old email/password modal.
// - The "Login" button now redirects to the backend's /api/facebook/login endpoint.
// - The app now checks the URL on load for login success parameters from the backend.
// - The dashboard now displays the real user's name and email after a successful login.
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-base">
                     ...
                     <div className="flex items-center gap-6">
                        <a href="#" className="text-slate-400 hover:text-white transition-colors"><XSocialIcon className="w-5 h-5"/></a>
                        <a href="#" className="text-slate-400 hover:text-white transition-colors"><LinkedInIcon className="w-6 h-6"/></a>
                        <a href="#" className="text-slate-400 hover:text-white transition-colors"><FacebookIcon className="w-6 h-6"/></a>
                        <a href="#" className="text-slate-400 hover:text-white transition-colors"><InstagramIcon className="w-6 h-6"/></a>
                    </div>
                </div>
